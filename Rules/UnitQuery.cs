...
public static class UnitQuery
{
  ...
  public static bool TryGetAliveUnitInNormalAttackRange(
    BattleState battleState,
    Unit attacker, Team targetTeam,
    [NotNullWhen(true)] out Unit? targetUnit)
  {
  ...
  public static bool TryGetAliveUnitAt(
    BattleState battleState,
